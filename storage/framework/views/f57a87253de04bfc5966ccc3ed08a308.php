  ...
  <ul class="navbar-nav navbar-right">
    ...
    <li class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        <div class="dropdown-title">Logged in <?php echo e(auth()->user()->created_at->diffForHumans()); ?></div>
...
</nav><?php /**PATH /storage/emulated/0/p/kunyuk/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>