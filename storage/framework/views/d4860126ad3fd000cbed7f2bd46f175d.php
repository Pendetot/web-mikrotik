<?php $__env->startSection('title', 'Edit Paket Langganan'); ?>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4>
                    <i class="fas fa-edit"></i> Edit Paket Langganan
                </h4>
            ...
            <div class="card-body">
                <form id="editPackageForm" action="<?php echo e(route('admin.packages.update', $package)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('code', $package->code)); ?>" 
                                       placeholder="PKG-001">
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="1" <?php echo e(old('is_active', $package->is_active) == '1' ? 'selected' : ''); ?>>Aktif</option>
                                    <option value="0" <?php echo e(old('is_active', $package->is_active) == '0' ? 'selected' : ''); ?>>Nonaktif</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                  rows="4"
                                  placeholder="Masukkan deskripsi paket (opsional)"><?php echo e(old('description', $package->description)); ?></textarea>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   <?php echo e(old('featured', $package->featured) ? 'checked' : ''); ?>>
...
$(document).ready(function() {
    ...
    $('#price, #original_price').trigger('input');
});
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /storage/emulated/0/p/kunyuk/resources/views/admin/packages/edit.blade.php ENDPATH**/ ?>